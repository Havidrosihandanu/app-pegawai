        ...
        <form action="{{ route('employees.update', $employee->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" class="w-full py-3" name="nama_lengkap" id="nama_lengkap"
                    ...
                    placeholder="Masukkan nama lengkap" required value="{{ $employee->nama_lengkap }}">
            </div>
            ...
            <div>
                ...
                <input type="email" class="w-full py-3" name="email" id="email"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    placeholder="contoh@email.com" required value="{{ $employee->email }}">
            </div>
            ...
            <div>
                ...
                <input type="text" class="w-full py-3" name="nomor_telepon" id="nomor_telepon"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    placeholder="081234567890" value="{{ $employee->nomor_telepon }}">
            </div>
            ...
            <div>
                ...
                <input type="date" class="w-full py-3" name="tanggal_lahir" id="tanggal_lahir"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $employee->tanggal_lahir }}">
            </div>
            ...
            <div>
                ...
                <textarea name="alamat" id="alamat" rows="3"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                    placeholder="Masukkan alamat lengkap">{{ $employee->alamat }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="date" class="w-full py-3" name="tanggal_masuk" id="tanggal_masuk"
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $employee->tanggal_masuk }}">
            </div>
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full py-3"
                    ...
                    <option value="non-aktif" {{ $employee->status == 'non-aktif' ? 'selected' : '' }}>Nonaktif</option>
                </select>
            </div>
